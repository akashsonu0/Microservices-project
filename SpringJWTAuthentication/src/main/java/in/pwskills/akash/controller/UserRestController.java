...
import in.pwskills.akash.payload.UserRequest;
import in.pwskills.akash.payload.UserResponse;
...
public class UserRestController {
	...
	public ResponseEntity<UserResponse> loginUser(@RequestBody UserRequest userRequest) {
		...
		return ResponseEntity.ok(new UserResponse(token, "GENERATED BY MR.AKASH"));
	}
